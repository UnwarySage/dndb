(defproject dbnd "0.1.0-SNAPSHOT"
  ...
  :ring {:handler dbnd.handler/app
         :uberwar-name "dbnd.war"}

  :min-lein-version "2.5.0"
  :uberjar-name "dbnd.jar"
  :main dbnd.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "dbnd.core/mount-root"}
             :compiler
             {:main "dbnd.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
  ...
  :profiles {:dev {:repl-options {:init-ns dbnd.repl}
