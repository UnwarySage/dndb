...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,cljs.core.keyword,((function (q){
return (function (p1__34608_SHARP_){
return q.get(p1__34608_SHARP_);
});})(q))
),q.getKeys()));
});
/**
...
var parameters = (function (){var or__4131__auto__ = reitit.coercion.coerce_BANG_.call(null,match__$1);
...
if(cljs.core.every_QMARK_.call(null,((function (match,temp__5733__auto__){
return (function (p1__34615_SHARP_){
return cljs.core.contains_QMARK_.call(null,path_params,p1__34615_SHARP_);
...
//# sourceMappingURL=frontend.js.map?rel=1573661530477
