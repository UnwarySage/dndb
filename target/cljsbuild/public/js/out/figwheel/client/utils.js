...
return (new CustomEvent(event_name,(function (){var obj35357 = ({"detail":data});
return obj35357;
})()));
} else {
...
var f = (function (){var pred__35364 = cljs.core._EQ_;
var expr__35365 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35364.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35365))){
return ((function (pred__35364,expr__35365){
return (function (p1__35358_SHARP_){
return console.warn(p1__35358_SHARP_);
});
;})(pred__35364,expr__35365))
} else {
if(cljs.core.truth_(pred__35364.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35365))){
return ((function (pred__35364,expr__35365){
return (function (p1__35359_SHARP_){
return console.debug(p1__35359_SHARP_);
});
;})(pred__35364,expr__35365))
} else {
if(cljs.core.truth_(pred__35364.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35365))){
return ((function (pred__35364,expr__35365){
return (function (p1__35360_SHARP_){
return console.error(p1__35360_SHARP_);
});
;})(pred__35364,expr__35365))
} else {
return ((function (pred__35364,expr__35365){
return (function (p1__35361_SHARP_){
return console.log(p1__35361_SHARP_);
});
;})(pred__35364,expr__35365))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35368){
...
var opts = map__35369__$1;
var eval_fn = cljs.core.get.call(null,map__35369__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35371_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35373,(0),null);
var v = cljs.core.nth.call(null,vec__35373,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1573661532416
