...
var o28456 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28456["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28457 = temp__5733__auto____$1;
return (o28457["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28020__auto__ = f;
return (o__28020__auto__["toString"]).call(o__28020__auto__);
} else {
return "";
}
}catch (e28458){var _ = e28458;
return "";
}});
...
try{var o__28020__auto___28460 = t;
(o__28020__auto___28460["cljs$lang$ctorPrWriter"]).call(o__28020__auto___28460,t,writer);
}catch (e28459){var __28461 = e28459;
}
...
var char_code = (function (){var o__28020__auto__ = (new String(char$));
return (o__28020__auto__["charCodeAt"]).call(o__28020__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28020__auto__ = String;
return (o__28020__auto__["fromCharCode"]).call(o__28020__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28462 = num_code;
switch (G__28462) {
case (1):
return (185);
...
var o__28020__auto__ = String;
return (o__28020__auto__["fromCharCode"]).call(o__28020__auto__,superscript_code);
});
/**
...
}catch (e28464){var _e__28027__auto__ = e28464;
return false;
}})())){
...
var vec__28465 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28465,(0),null);
...
var temp__5733__auto____$1 = (o28468["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28469 = temp__5733__auto____$1;
return (o28469["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___28476 = arguments.length;
var i__4731__auto___28477 = (0);
while(true){
if((i__4731__auto___28477 < len__4730__auto___28476)){
args__4736__auto__.push((arguments[i__4731__auto___28477]));

var G__28478 = (i__4731__auto___28477 + (1));
i__4731__auto___28477 = G__28478;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28472){
var vec__28473 = p__28472;
var ns_detector = cljs.core.nth.call(null,vec__28473,(0),null);
...
var G__28479 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28480 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28479;
remaining_tokens = G__28480;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28470){
var G__28471 = cljs.core.first.call(null,seq28470);
var seq28470__$1 = cljs.core.next.call(null,seq28470);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28471,seq28470__$1);
});
...
var vec__28484 = cljs.core.split_with.call(null,(function (p1__28483_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28483_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28484,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28484,(1),null);
...
var vec__28490 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28490,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28490,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28493 = cljs.core.rest.call(null,remaining_tokens);
var G__28494 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28493;
name_tokens = G__28494;
continue;
} else {
...
var vec__28497 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28497,(0),null);
var arity = cljs.core.nth.call(null,vec__28497,(1),null);
var vec__28500 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28500,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28500,(1),null);
var vec__28503 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28503,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28503,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28503,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28503,(3),null);
...
var vec__28509 = result;
var munged_ns = cljs.core.nth.call(null,vec__28509,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28509,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28509,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28509,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28509,(4),null);
var arity = cljs.core.nth.call(null,vec__28509,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28513 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__28513,(0),null);
var args = cljs.core.nth.call(null,vec__28513,(1),null);
var vec__28516 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28516,(0),null);
var name = cljs.core.nth.call(null,vec__28516,(1),null);
...
var G__28519 = (arity + (1));
var G__28520 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28521){
var vec__28522 = p__28521;
var arity = cljs.core.nth.call(null,vec__28522,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__28522,(1),null);
...
return cljs.core.get.call(null,arities,p1__28525_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__28526_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___28533 = arguments.length;
var i__4731__auto___28534 = (0);
while(true){
if((i__4731__auto___28534 < len__4730__auto___28533)){
args__4736__auto__.push((arguments[i__4731__auto___28534]));

var G__28535 = (i__4731__auto___28534 + (1));
i__4731__auto___28534 = G__28535;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28529){
var vec__28530 = p__28529;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28530,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28527){
var G__28528 = cljs.core.first.call(null,seq28527);
var seq28527__$1 = cljs.core.next.call(null,seq28527);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28528,seq28527__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__28538__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28538__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28538__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28538__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28539 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28539,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28539,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28539,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28539,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28539,(4),null);
var arity = cljs.core.nth.call(null,vec__28539,(5),null);
...
var o__28020__auto__ = f;
return (o__28020__auto__["getBasis"]).call(o__28020__auto__);
});
/**
...
}catch (e28543){var _e__28027__auto__ = e28543;
...
var G__28544 = (obj[cljs.core.first.call(null,path)]);
var G__28545 = cljs.core.rest.call(null,path);
obj = G__28544;
path = G__28545;
continue;
} else {
...
return (function (accum,p__28546){
var vec__28547 = p__28546;
var bit = cljs.core.nth.call(null,vec__28547,(0),null);
var protocol = cljs.core.nth.call(null,vec__28547,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28550){
var vec__28551 = p__28550;
var ns = cljs.core.nth.call(null,vec__28551,(0),null);
var name = cljs.core.nth.call(null,vec__28551,(1),null);
var selector = cljs.core.nth.call(null,vec__28551,(2),null);
...
return (function (p__28555){
var vec__28556 = p__28555;
var munged_name = cljs.core.nth.call(null,vec__28556,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28556,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__28556,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28554_SHARP_){
return (obj[cljs.core.first.call(null,p1__28554_SHARP_)]);
});})(name,sorted_matches,vec__28556,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1573661523939
