...
}catch (e34847){var _e = e34847;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___34850 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___34850)){
var seen_errors_34851 = temp__5733__auto___34850;
if(cljs.core.truth_(seen_errors_34851.has(self))){
} else {
seen_errors_34851.add(self);

var temp__5735__auto___34852 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___34852)){
var sense_34853 = temp__5735__auto___34852;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_34853)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1573661530944
